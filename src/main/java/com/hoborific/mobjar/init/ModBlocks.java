package com.hoborific.mobjar.init;

import com.hoborific.mobjar.MobJar;
import com.hoborific.mobjar.blocks.BlockJar;
...
@Mod.EventBusSubscriber(modid = MobJar.MODID)
